...
export class UserExerciseController {
  ...
  async find(
    ...
    return this.userRepository.exercises(id).find(filter);
  }
  ...
  async create(
    ...
    return this.userRepository.exercises(id).create(exercise);
  }

  @patch('/users/{id}/exercises', {
    responses: {
      '200': {
  ...
  async patch(
    ...
    return this.userRepository.exercises(id).patch(exercise, where);
  }

  @del('/users/{id}/exercises', {
    responses: {
      '200': {
  ...
  async delete(
    ...
    return this.userRepository.exercises(id).delete(where);
  }
}
